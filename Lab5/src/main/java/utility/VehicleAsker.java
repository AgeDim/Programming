...
public class VehicleAsker {
    ...
    public String inputVehicleName() {
        ...
        return input("Input name: ", "Wrong name! Try again: ", interfc);
    }
    ...
    public Float inputX() {
        ...
        return input("input X coordinate: (x <= 252) ", "Wrong Coordinate! Try again: ", interfc);
    }
    ...
    public Float inputY() {
        ...
        return input("Input Y coordinate: (y <= 420) ", "Wrong Coordinate! Try again: ", interfc);
    }
    ...
    public int inputEnPower() {
        ...
        return input("Input engine power", "Wrong Power Format! Try again: ", interfc);
    }
    ...
    public int inputDistTravel() {
        ...
        return input("Input distance travelled: ", "Wrong distance! Try again: ", iterfc);
    }
    ...
    public boolean askQuestion(String question) throws IncorrectInputInScriptException {
        ...
        while (true) {
            try {
                ...
                Console.printerror("anther is not recognized!");
                if (fileMode) throw new IncorrectInputInScriptException();
            } catch (NotInDeclaredLimitsException exception) {
                Console.printerror("anther is '+' or '-'!");
                if (fileMode) throw new IncorrectInputInScriptException();
            }
        }
